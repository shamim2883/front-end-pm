...
?><h2><?php esc_html_e( 'New Announcement', 'front-end-pm' ); ?></h2>
<?php
if ( ! fep_current_user_can( 'add_announcement') ) {
	echo '<div class="fep-error">' . esc_html__( 'You do not have permission to create announcement!', 'front-end-pm' ) . '</div>';
